...
# print and also write the info to a file
def printFortune(inputJson):
    with open(inputJson, 'r') as input:
        data = json.load(input)
        group = 'friends'       # choose 'friends' or 'families' from input json
        for i in data[group]:
